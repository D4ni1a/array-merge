        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (textBox4.Text.Length != 0) //Если имя нового массива есть
                {
                    ...
                    Massiv C = B.Concat(Program.Dict[n2]); //Создание экземпляра класса для метода Concat для В
                ...
                else { MessageBox.Show("Введите имя массива", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error); } //Если имя нового массива отсутсвует
            }
